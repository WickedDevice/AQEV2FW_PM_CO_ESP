...
#define EEPROM_NO2_ZERO_NEGATIVE_RESULTS (EEPROM_PM10P0_CAL_OFFSET - 1)
...
#define BACKUP_STATUS_PARTICULATE_CALIBRATION_BIT (3)
...
void initializeHardware(void) {
  // turn on the particulate sensors
  ...
  Serial.println(F(" |        CO / PM Sensor Suite        |"));
...
//    configInject("restore key\r");
    ...
    eeprom_write_block("aqev2_co_pm_esp", (void *) EEPROM_UPDATE_FILENAME, 32);
  }
...
boolean publishHeartbeat(){
  ...
  "\"converted-value\":%d,"
  "\"firmware-version\":\"%s\","
  "\"publishes\":[\"co\",\"particulate\",\"temperature\",\"humidity\"%s],"
  "\"counter\":%lu"
